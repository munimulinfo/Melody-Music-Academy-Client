            ...
            >
                <SwiperSlide>
                    <div className='flex justify-center items-center w-full h-96 lg:h-[600px]'>
                     <img className='w-full h-full  contrast-100 brightness-75 ' src={img3} alt="slideer" />
                     </div>
                </SwiperSlide>
                <SwiperSlide>
                    
                    <div className='flex justify-center items-center w-full h-96 lg:h-[600px] rounded-lg'>
                     <img className='w-full h-full contrast-100 brightness-75' src={img4} alt="slideer" />
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className='flex justify-center items-center w-full h-96 lg:h-[600px]'>
                     <img className='w-full h-full contrast-100 brightness-75 ' src={img5} alt="slideer" />
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className='flex justify-center items-center w-full h-96 lg:h-[600px]'>
                     <img className='w-full h-full contrast-100 brightness-75 ' src={img6} alt="slideer" />
                    </div>
                </SwiperSlide>
